...
public class SonstigesView extends JPanel implements Observer, ActionListener, KeyListener{
	...
	public SonstigesView(Controller ctrl) {
...
//
		...
		panel4.setBorder(MyBorderFactory.createMyBorder(" Sonstiges "));
