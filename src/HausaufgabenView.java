...
public class HausaufgabenView extends JPanel implements Observer, ActionListener, KeyListener{
	...
	public HausaufgabenView(Controller ctrl) {
...
//		add(panel5, new GridBagConstraints(1,2,1,1,1.0,1.0,GridBagConstraints.CENTER, GridBagConstraints.BOTH,new Insets(10,10,10,10),0,0));
		...
		panel6.setPreferredSize(new Dimension(200, 400));
		...
		panel7.setPreferredSize(new Dimension(200, 400));
		...
		panel8.setPreferredSize(new Dimension(200, 400));
